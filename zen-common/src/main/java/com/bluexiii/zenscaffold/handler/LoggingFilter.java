...
public class LoggingFilter extends OncePerRequestFilter {
    ...
    protected static final Logger filterLogger = LoggerFactory.getLogger(LoggingFilter.class);
    ...
    private void logRequest(final HttpServletRequest request) {
        ...
        if (request instanceof RequestWrapper && !isMultipart(request) && !isBinaryContent(request)) {
            ...
            try {
                ...
                filterLogger.warn("Failed to parse request payload", e);
            }

        }
        filterLogger.info(msg.toString());
    }
    ...
    private void logResponse(final ResponseWrapper response) {
        ...
        try {
            ...
            filterLogger.warn("Failed to parse response payload", e);
        }
        filterLogger.info(msg.toString());
    }
